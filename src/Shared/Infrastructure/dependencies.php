...
$horarioEspecialistaRepository = new HorarioEspecialistaRepository($db);
$especialistaService = new EspecialistaService($especialistaRepository, $especialistaServicioRepository, $horarioEspecialistaRepository);
